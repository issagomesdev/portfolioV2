        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-32 items-start">
          <div className="lg:col-span-7">
            ...
            <p className="text-on-surface-variant text-lg md:text-xl leading-relaxed max-w-2xl font-light">
              ...
              Minha trajetória combina desenvolvimento <span className="text-primary font-medium">frontend</span>, <span className="text-secondary font-medium">backend</span> e mobile em projetos que exigem performance, usabilidade e estrutura sólida. De landing pages e dashboards a APIs, sistemas completos e aplicativos, transformo necessidades reais em soluções digitais funcionais, escaláveis e bem apresentadas.
