      ...
      <div className="max-w-7xl mx-auto px-6 py-20 w-full">
        ...
        <div className="mb-20 text-center md:text-left">
          ...
          <h1 className="font-headline text-5xl md:text-7xl font-bold tracking-tighter mb-6 bg-gradient-to-r from-primary to-tertiary-fixed-dim bg-clip-text text-transparent">
           Interfaces elegantes. <br /> Backends sólidos. <br /> Produtos prontos para crescer.
          </h1>
          <p className="text-on-surface-variant max-w-2xl text-lg leading-relaxed font-body">
            Construindo interfaces precisas e backends resilientes através de uma abordagem orientada a dados e
            elegância estética. Do mobile ao desktop, transformo visão em código.
          </p>
        </div>
