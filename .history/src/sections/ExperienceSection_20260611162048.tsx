...
export default function ExperienceSection() {
  ...
  <span className="text-tertiary font-medium">Mobile</span> em projetos reais que exigem
  performance, usabilidade e estrutura sólida. De landing pages e dashboards a APIs, sistemas
  completos e aplicativos, transformo necessidades em soluções digitais funcionais, escaláveis e bem
  apresentadas.
</p>
            </p>
          </div>
